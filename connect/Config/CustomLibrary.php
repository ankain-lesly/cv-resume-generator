...
class CustomLibrary {
	...
	public static function generateKey(int $length = 8): string
	{
  ...
  // Send Toast
  public static function setToast(string $message, string $redirectURL) {
    $_SESSION['toast']['message'] = $message;
    exit("<script>window.location = '".$redirectURL."';</script>");
  }
}