    ...
    <div class="side-bar">
      <div class="mugshot">
        <div class="logo">
          ...
          <p class="logo-text">kj <i class="fas fa-radiation"></i></p>
        </div>
      </div>
      <p class="info <?= empty(get($personal, 'address')) ? 'section_hide' : '' ?>"><?= get($personal, 'address') ?></p>
      <p class="info <?= empty(get($personal, 'date_of_birth')) ? 'section_hide' : '' ?>">
        <?= get($personal, 'date_of_birth') ?></p>
      ...
      <p class="rela-block social_media twitter">Twitter stuff</p>
      <p class="rela-block social_media pinterest">Pinterest things</p>
      <p class="rela-block social_media linked-in">Linked-in man</p>
