...
<head>
  ...
  <link rel="stylesheet" href="/static/styles/Design_1.css">
</head>
...
<body>
  <article id="template_main">
    <div class="rela-block top-bar">
      <div class="caps name">
        <h1 class="abs-center"><?= getP('firstname') . ' ' . getP('lastname') ?></h1>
      </div>
    </div>
    <div class="side-bar">
      ...
      <p class="txt-center"><?= getP('headline') ?></p>
    ...
    <div class="rela-block content-container">
      <!-- ABOUT -->
      <div class=" <?= getP('about')  ? '' : 'section_hide' ?>">
        <div class="rela-block caps greyed heading">Profile</div>
        <p class="long-margin"><?= getP('about') ?></p>
      </div>
